...
def select_quadrilateral_from(image):
    ...
    if selection_dict['points selected'][0][0] > selection_dict['points selected'][1][0]:
        selection_dict['points selected'][0], selection_dict['points selected'][1] =         selection_dict['points selected'][1], selection_dict['points selected'][0]

    if selection_dict['points selected'][3][0] > selection_dict['points selected'][2][0]:
        selection_dict['points selected'][3], selection_dict['points selected'][2] =         selection_dict['points selected'][2], selection_dict['points selected'][3]
...
if __name__ == '__main__':
    ...
    while True:
        ...
        intervehicular_distance, deleted_count = update_or_deregister(selected_boxes, vehicles, distance)
        ...
        cv2.putText(image, "intervehicle distance: " + str(intervehicular_distance), (0, 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(image, "Count: " + str(vehicle_count), (450, 20), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
