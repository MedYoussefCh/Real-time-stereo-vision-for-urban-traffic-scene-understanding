...
master_path_to_dataset = "C:\\Users\\Youssef\\Desktop\\STEREOVISION_DATA"

directory_to_cycle_left = "1"
directory_to_cycle_right = "2"
...
def run_program():
    ...
    for filename_left in left_file_list:
        ...
        if (".jpg" in filename_left) and (os.path.isfile(full_path_filename_right)):
